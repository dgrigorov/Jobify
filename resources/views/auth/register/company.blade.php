...
<div class="row">
    <div class="col-md-8 col-md-offset-2">
        <div class="panel panel-default">
            <div class="panel-heading text-center">Register Company</div>
            <div class="panel-body">
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/register/company') }}">
                    ...
                    <div class="form-group{{ $errors->has('webaddress') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="webaddress" type="text" class="form-control" name="webaddress" value="{{ old('webaddress') }}" autofocus>
